			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
			    ...
			    <div class="carousel-inner" role="listbox">
			        <div class="item active">
			            <a href="GV_HoSo.jsp"><img src="Image/1.jpg" alt="Chania"></a>
			        </div>

			        <div class="item">
			            <a href="GV_HoSo.jsp"><img src="Image/2.jpg" alt="Chania" ></a>
			        </div>

			        <div class="item">
			           <a href="GV_HoSo.jsp"> <img src="Image/3.png" alt="Flower"></a>
			        </div>

			        <div class="item">
			            <a href="GV_HoSo.jsp"><img src="Image/4.jpg" alt="Flower" ></a>
			        </div>
			    </div>
